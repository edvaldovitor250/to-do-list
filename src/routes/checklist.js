...
router.get('/', async (req, res) => {
    try {
        ...
        res.status(500).render('error', {error: 'Erro ao exibir as Listas de tarefas'})
...
router.get('/new', async (req, res) =>{
    try {
        ...
        res.status(200)
        .render('checklists/new', {checklist: checklist})
...
router.get('/:id/edit'), async (req, res) => {
    try {
        ...
        res.status(500).render('error', {error: 'Erro ao carregar o formulário.'})
    }
}
